...
final sendMessageProvider =
    Provider.family<Future<void> Function(String), String>((ref, roomId) {
...
class OpponentInfo {
  ...
  OpponentInfo({this.nickname, this.isMale, this.sport});
}

// 상대방 정보 받기 (앱바에 표시)
final opponentInfoProvider =
    FutureProvider.family<OpponentInfo?, ({String roomId, String opponentId})>((
      ref,
      params,
    ) async {
